        ...
        for index_r, a_row in enumerate(test_graph.matrix):
            for index_b, a_node in enumerate(a_row):
                ...
                for line in line_list:
                    draw_line(line[0],line[1], canvas)

                
                for item in item_list:
                    if item in prev_seeker_list:
                        item_coords = convert_index(item)
                        it = test_graph.matrix[item_coords[0]][item_coords[1]]
