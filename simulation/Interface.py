...
class Interface():
    ...
    def comboboxs(self):
          ...
          self.comboSearching.config(values = ("Bredth first","A*"))
          ...
          self.comboSorting.config(values = ("Alphabetically","Number"))
